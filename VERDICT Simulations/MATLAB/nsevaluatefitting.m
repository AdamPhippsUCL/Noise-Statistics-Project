...
function [bias, variance] = nsevaluatefitting(scheme, schemename, modeltype, fittingtype, tissue_params, opts)
...
arguments
    ...
    opts.T2train = 100 % T2 value used in training
    opts.solver
