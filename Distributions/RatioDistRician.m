...
arguments
    ...
    % Calibration
    opts.calibrationfolder = "C:\Users\adam\OneDrive - University College London\UCL PhD\PhD Year 1\Projects\Noise Statistics Project\Code\Noise-Statistics-Project\Distributions\Calibration Curves"
...
if and(b0SNR<=7, opts.N0>1)
    ...
    b0sigma = sigma0*MeanDict(opts.N0);
end
