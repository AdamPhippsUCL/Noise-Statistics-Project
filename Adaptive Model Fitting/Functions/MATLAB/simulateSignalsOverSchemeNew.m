...
function signals  = simulateSignalsOverSchemeNew(scheme, modeltype, tissue_params, opts)
...
for scanIndx = 1:nscan
    ...
    switch modeltype
        ...
        case 'Original VERDICT'
            ...
            tps = [tissue_params.fIC*tissue_params.fRs, tissue_params.fEES, tissue_params.fVASC];
    ...
    switch opts.noisetype
        ...
        case 'Ratio'
            ...
            [signalDist, zs] = RatioDistRicianNew(b0signal, bsignal, opts.sigma0, N0 = N0, Nb = Nb);
