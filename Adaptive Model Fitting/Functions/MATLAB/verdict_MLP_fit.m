...
%% ORIGINAL MLP FITTING

if or( strcmp(opts.noisetype, 'Rice'),  strcmp(opts.noisetype, 'Ratio'))
...
%% ADAPTIVE MLP FITTING

if strcmp(opts.noisetype, 'Adaptive')
